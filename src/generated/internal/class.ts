...
/**
  ...
  /**
   * `prisma.promptLike`: Exposes CRUD operations for the **PromptLike** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more PromptLikes
    * const promptLikes = await prisma.promptLike.findMany()
    * ```
    */
  get promptLike(): Prisma.PromptLikeDelegate<ExtArgs, { omit: OmitOpts }>;
}
