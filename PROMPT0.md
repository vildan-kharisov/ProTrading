Ты — ведущий fullstack-разработчик. Работаем в существующем проекте ProStore (Next.js App Router + TypeScript + Prisma + Neon/Postgres + Auth). Нужно добавить лайки к ПУБЛИЧНЫМ промтам.

ЦЕЛЬ
- Пользователь может поставить лайк публичному промту.
- Ограничение: 1 пользователь = 1 лайк на промт (повторное нажатие снимает лайк — toggle).
...
4) UI:
   ...
   - Вставь кнопку в карточку промта в “Публичные промты”.
